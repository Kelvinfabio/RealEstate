        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Please sign-in to your account and start to register your properties</p>
              ...
              <p class="text-center">
                ...
                <a href="registerProprietario.php">
...
<script>
  function login() {
    ...
    fetch('http://localhost/RealEstate/view/links.php/user/loginproprietario', {
        method: 'POST',
        headers: {
    ...
    <script src="view/assets/Sneat/vendor/libs/jquery/jquery.js"></script>
    <script src="view/assets/Sneat/vendor/libs/popper/popper.js"></script>
    <script src="view/assets/Sneat/vendor/js/bootstrap.js"></script>
    ...
    <!-- Main JS -->
    <script src="view/assets/Sneat/js/main.js"></script>
